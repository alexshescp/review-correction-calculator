let translations = {
    "ru": {
        ...
        "requiresReservation": "Платформа требует платные ВОЗВРАТНЫЕ резервирования (например, отели):",
        "reservationCostLabel": "Средняя стоимость резервирования (возвращается через Ваши же системы) ₽:",
        ...
        "requestTitle": "Заявка на услуги тайного покупателя с отзывами об объекте",
    ...
    "en": {
        ...
        "promoItem1Text": "Calculation & request in 2 minutes",
        ...
        "requestTitle": "Request for a hidden buyers with reviews",
